...
const products = [
  {
    ...
    colors: [
      { name: "Blanco/Café", hex: "#F5F5DC", hex2: "#8B4513" },
      { name: "Blanco/Negro", hex: "#FFFFFF", hex2: "#000000" }
    ],
    badge: "NUEVO"
  },
  {
    ...
    colors: [
      { name: "Negro/Plata", hex: "#000000", hex2: "#C0C0C0" },
      { name: "Azul/Plata", hex: "#1e3a8a", hex2: "#C0C0C0" },
  ...
  },
  {
    ...
    colors: [
      { name: "Dorado Completo", hex: "#D4AF37" },
      { name: "Cara Blanca", hex: "#FFFFFF" },
      { name: "Cara Negra", hex: "#000000" },
      { name: "Blanco/Bronce", hex: "#FFFFFF", hex2: "#CD7F32" }
    ],
    badge: "ELEGANTE"
  },
  {
    ...
    price: 330,
    images: [
      "images/pd629-silicona-1.jpg",
      "images/pd629-silicona-2.jpg",
      "images/pd629-silicona-3.jpg"
    ],
  ...
  },
  {
    ...
    price: 330,
    images: [
      "images/pd629-acero-1.jpg",
      "images/pd629-acero-2.jpg",
      "images/pd629-acero-3.jpg"
    ],
  ...
  },
  {
    ...
    colors: [
      { name: "Celeste Diamante", hex: "#87CEEB" },
      { name: "Cara Azul Marino", hex: "#000080" },
      { name: "Negro", hex: "#000000" }
    ],
    badge: "PREMIUM"
  },
  ...
  },
  {
    ...
    description: "Reloj ejecutivo de lujo con diseño sofisticado. Perfecto balance entre elegancia corporativa y versatilidad casual.",
    shortDescription: "Lujo ejecutivo versátil",
    features: [
      "Caja de 41mm - Presencia ejecutiva",
      "Movimiento de cuarzo CHENLONG",
      "Resistente al agua 3ATM (30 metros)",
      "Correa de acero inoxidable 25mm",
      "Día y fecha integrados",
      "Manecillas luminosas",
      "Cristal Hardlex resistente",
      "Peso: 110g"
  ...
  },
  {
    ...
    price: 280,
    images: [
      "images/pd613-acero-1.jpg",
      "images/pd613-acero-2.jpg",
      "images/pd613-acero-3.jpg"
    ],
  ...
  },
  {
    ...
    price: 280,
    images: [
      "images/pd613-cuero-1.jpg",
      "images/pd613-cuero-2.jpg",
      "images/pd613-cuero-3.jpg"
    ],
